...
export default function App() {
  ...
  useEffect(() => {
    ...
    addNotificationResponseReceivedListener(handleNotification);
  }, []);

  const getCustomerFullName = (customer) => {
    let customerFullName = customer.first_name != null ? customer.first_name + ' ' : '';
    customerFullName += customer.last_name != null ? customer.last_name : '';
    if (customerFullName === '') {
      customerFullName = customer.whatsapp_name != null ? customer.whatsapp_name : customer.phone;
    }
